...
public class AddAdmin extends JDialog {
    ...
    public AddAdmin() {
        ...
        ((JComponent) getContentPane()).setOpaque(false); // 背景设置
        ...
        ok.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if( !upass.equals(repass) ) {
                    JOptionPane.showMessageDialog(AddAdmin.this, "password and confirm password should be the same");
                    return;
                }
                //后面连接数据库
                try {
                    ...
                    if(result > 0){
                        JOptionPane.showMessageDialog(AddAdmin.this, "添加成功！");
                        AddAdmin.this.dispose();
                    } else {
