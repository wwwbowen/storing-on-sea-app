...
public class Alterpassword2 extends JDialog {
        ...
        ok.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                   ...
                   if (rs.next()) {
                    ...
                    if (result == 1) {
                            ...
                            if(!upass.equals(repass)){JOptionPane.showMessageDialog(Alterpassword2.this, "请保证两次输入的密码相同！");}
                            else {
                ...
                if (rs != null) {
                    ...
                    JOptionPane.showMessageDialog(Alterpassword2.this, "驱动加载失败");
                } catch (SQLException e1) {
                    JOptionPane.showMessageDialog(Alterpassword2.this, "添加失败");
                    e1.printStackTrace();
                }
