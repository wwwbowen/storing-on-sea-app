    ...
    public CheckWarehouse() {
        ...
        ok.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(uname.length() < 2) {
                    JOptionPane.showMessageDialog(CheckWarehouse.this, "用户名太短！");
                    return;
                }
                if(upass.length() < 2) {
                    JOptionPane.showMessageDialog(CheckWarehouse.this, "too short");
                    return;
                }
                if( !upass.equals(repass) ) {
                    JOptionPane.showMessageDialog(CheckWarehouse.this, "password and confirm password should be the same");
                    return;
                }
                //后面连接数据库
                try {
                    ...
                    if(result > 0){
                        JOptionPane.showMessageDialog(CheckWarehouse.this, "添加成功！");
                        CheckWarehouse.this.dispose();
                    } else {
                            JOptionPane.showMessageDialog(CheckWarehouse.this, "添加失败");
                    }
                    if(statement != null) {
                        statement.close();
                    }
                    ...
                    JOptionPane.showMessageDialog(CheckWarehouse.this, "驱动加载失败");
