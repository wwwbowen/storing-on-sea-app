    ...
    public Employee() {
        ...
        ok.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (uname.length() < 2) {
                    JOptionPane.showMessageDialog(Employee.this, "用户名太短！");
                    return;
                }
                if (upass.length() < 2) {
                    JOptionPane.showMessageDialog(Employee.this, "too short");
                    return;
                }
                if (!upass.equals(repass)) {
                    JOptionPane.showMessageDialog(Employee.this, "password and confirm password should be the same");
                    return;
                }
                // 后面连接数据库
                try {
                    ...
                    if (result > 0) {
                        JOptionPane.showMessageDialog(Employee.this, "添加成功！");
                        Employee.this.dispose();
                    } else {
