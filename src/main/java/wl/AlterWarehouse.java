...
public class AlterWarehouse extends JDialog {
    ...
    public AlterWarehouse() {
        ...
        ok.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(uname.length() < 1) {
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "ID不能为空！");
                    return;
                }
                if(upass.length() < 1) {
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "仓库储存类型不能为空");
                    return;
                }
                
                if(uage.length() < 1) {
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "价格栏不能为空！");
                    return;
                }
                if(uaddress.length() < 1 ) {
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "地址栏不能为空！");
                    return;
                }
                //后面连接数据库
                try {
                    ...
                    if(result > 0){
                        JOptionPane.showMessageDialog(AlterWarehouse.this, "修改成功！");
                        AlterWarehouse.this.dispose();
                    } else {
                            JOptionPane.showMessageDialog(AlterWarehouse.this, "修改失败");
                    }
                    if(statement != null) {
                        statement.close();
                    }
                    ...
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "驱动加载失败");
                } catch (SQLException e1) {
                    JOptionPane.showMessageDialog(AlterWarehouse.this, "添加失败");
                    e1.printStackTrace();
                }
