 ...
 * MainFrame
 */
public class Costomer extends JFrame {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demo?useSSL=false&serverTimezone=UTC", "bwwu", "292504");
                     ...
                     JOptionPane.showMessageDialog(Costomer.this, "驱动加载失败");
                 } catch (final SQLException e1) {
                    JOptionPane.showMessageDialog(Costomer.this, "添加失败");
                    e1.printStackTrace();
                }
